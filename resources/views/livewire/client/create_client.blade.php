                    ...
                    <div class="">
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                             ...
                             <select  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" wire:model="civ" id="exampleFormControlInput1">
