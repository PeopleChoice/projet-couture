    ...
    <div class="max-w-full mx-auto sm:px-8 lg:px-10">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div class="dark:text-white">
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                 <b>Prénom & Nom : </b>  {{$clients['prenom']}}  {{$clients['nom']}} &nbsp;&nbsp; &nbsp;&nbsp; | &nbsp;&nbsp; &nbsp;&nbsp;<b>Télèphone : </b>  {{$clients['mobile']}}  
          ...
          <br><br>
            ...
            class="bg-green-700 text-white font-bold py-2 px-4 rounded mr-10 content-end">Menusration</button>
